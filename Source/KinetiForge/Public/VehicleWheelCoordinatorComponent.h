...
class UVehicleAeroBaseComponent;
...
protected:
	...
	UPROPERTY()
	TArray<TWeakObjectPtr<UVehicleAeroBaseComponent>> RegisteredAeros;
...
public:	
	...
	void RegisterAero(UVehicleAeroBaseComponent* NewAero);
	void UnregisterAero(UVehicleAeroBaseComponent* Aero);
	...
	void UpdateAeros(const float InDeltaTime);
};
